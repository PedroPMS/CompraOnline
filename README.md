...
> O sistema "CompraOnline" tem como objetivo oferecer opção para clientes fazerem compra de roupas e acessórios online. Para realizar as vendas, é necessário que o sistema armazene diversas informações. Para um usuário realizar compras no sistema, é necessário que ele faça uma conta, onde será armazenado seu nome, e-mail, senha, telefone, cpf e endereço. A compra é realizado pelo usuário e nele é contido a data que a compra foi realizada, preço total da compra. A compra contem os produtos que são identificados pelo seu nome, seu preço e quantidade escolhida pelo cliente. Uma compra pode ter um ou vários produtos. Para que o produto esteja disponível, é necessário que o estoque tenha o mesmo armazenado, e mostre sua quantidade total. O estoque pode ter vários produtos ou nenhum. Para que o pagamento seja efetuado, é necessário que armazene a forma de pagamento, valor do frete e o valor total da compra. O usuário pode ter uma ou várias compras. Assim como cada compra pode ter um ou vários produtos. E toda compra, precisa, necessariamente, de que seu pagamento seja efetuado. O objetivo inicial da empresa é oferecer produtos de vestuário ou acessórios para seus usuários de forma online, com objetivo de evitar aglomerações em tempos de pandemia.
